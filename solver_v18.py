"""
AutoSolver v18: 基于v17 + 精确backup增益 + 更激进低意愿策略
==============================================================
v17平台分719.21，low_willingness仍高达1803
核心改进：
1. 用_slot_cost精确计算backup增益（而非简化公式）
2. 低意愿时用更高penalty评估backup（用200而非100）
3. 低意愿时允许更多backup轮次（8轮）
4. backup选择时优先选高willingness骑手
5. 保留v9safe的加权平均模型评估
"""
