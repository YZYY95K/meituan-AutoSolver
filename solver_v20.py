"""
AutoSolver v20: 合规约束下深度优化
====================================
v19 multi-slot被平台拒绝（2910分），骑手不可跨slot
v18平台分719.29，low_willingness=1803, scarce_couriers=1607
核心改进：
1. 优化primary选择：混合配对策略（1高w+1低w比同质配对更优）
2. 优化backup策略：更精确的增益计算
3. ALNS优化：更有效的destroy/repair
4. 整体时间分配优化
"""
